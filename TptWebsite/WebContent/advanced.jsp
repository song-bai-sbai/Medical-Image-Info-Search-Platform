...
<script language="javascript" src="js/advancedJS.js"></script>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-5 col-sm-6">
					<hr class="section-heading-spacer">
					<div class="clearfix"></div>
					<h2 class="section-heading">Please input query</h2>
					<form class="am-form">
						<div class="am-form-group">
							<textarea class="" rows="20" id="query"><%out.print(PageSelectionInfo.defaultQuery);%></textarea>
						</div>
					</form>
				</div>
				...
				<div class="col-lg-6">
					<ul class="list-inline banner-social-buttons">
						<li><a class="btn btn-default btn-lg"> <span
								class="network-name"
								onclick="submitForm('Project','TSS','Paticipant','Sample','Vial')">Search</span></a></li>
